...
INPUT_FASTA="$INPUT_DIR/repertorio_A_insilico_25600_seqs.fasta"
FMT7_OUT="$OUTPUT_DIR/repertorio_A_insilico_25600_seqs_igblast.fmt7"
DB_OUT="$OUTPUT_DIR/repertorio_A_insilico_25600_seqs_db-pass.tsv"
CLONE_OUT="$OUTPUT_DIR/repertorio_A_insilico_25600_seqs_clone-pass.tsv"
