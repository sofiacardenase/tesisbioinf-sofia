...
INPUT_FASTA="$INPUT_DIR/repertorio_B_insilico_102400_seqs.fasta"
FMT7_OUT="$OUTPUT_DIR/repertorio_B_insilico_102400_seqs_igblast.fmt7"
DB_OUT="$OUTPUT_DIR/repertorio_B_insilico_102400_seqs_db-pass.tsv"
CLONE_OUT="$OUTPUT_DIR/repertorio_B_insilico_102400_seqs_clone-pass.tsv"
